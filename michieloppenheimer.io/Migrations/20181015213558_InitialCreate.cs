        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasCoverPhoto = table.Column<bool>(nullable: false),
                    Tags = table.Column<string>(maxLength: 200, nullable: true),
                    PostCoverPhoto = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PubDate = table.Column<DateTime>(nullable: false),
                    CommentApproved = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedialUrl = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
