(function () {
    ...
    if (edit) {
        // Setup editor
        var editPost = document.getElementById("textarea#Content.uk-text-area");
        ...
        tinymce.init({
            ...
            toolbar1: 'formatselect | bold italic blockquote forecolor backcolor | codesample | imageupload link | alignleft aligncenter alignright  | numlist bullist outdent indent | fullscreen',
